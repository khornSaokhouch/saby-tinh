        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
          ...
          >
            <h2 className="text-base font-bold mb-4 border-b border-gray-100 pb-2">
              {initialData ? 'Update Logistics' : 'Add Carrier'}
            </h2>

            <form onSubmit={handleFormSubmit} className="space-y-3">
              <div>
                <label className="block text-xs font-bold mb-1.5 text-gray-700">Carrier Name</label>
                <input 
                  type="text" 
                  value={name} 
              ...
              <div>
                <label className="block text-xs font-bold mb-1.5 text-gray-700">Price ($)</label>
                <input 
                  type="number" 
                  step="0.01" 
                  value={price} 
