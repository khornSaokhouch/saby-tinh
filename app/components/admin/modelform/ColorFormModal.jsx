...
export default function ColorFormModal({ isOpen, onClose, onSubmit, initialData, isSubmitting, categories }) {
          ...
          >
            ...
            <form onSubmit={(e) => { e.preventDefault(); onSubmit(formData); }} className="space-y-3">
              <div>
                ...
                <div className="border border-gray-200 rounded-md p-2 max-h-32 overflow-y-auto grid grid-cols-2 gap-2 bg-gray-50">
                  {(categories || []).map(cat => (
              ...
              <div>
                <label className="block text-xs font-bold mb-1.5 text-gray-700">Color Name</label>
                <input
                  type="text"
                  value={formData.name}
