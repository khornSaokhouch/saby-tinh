import { X, Check, Loader2, Briefcase, ImageIcon } from 'lucide-react';
...
export default function BrandFormModal({ isOpen, onClose, onSubmit, initialData, isSubmitting }) {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setFormData({ name: '', status: true, image: null });
      ...
      >
        <div className="p-8 font-sans">
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Brand Identity</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <label className="text-[8px] font-black text-slate-400 uppercase tracking-widest mt-2">Brand Profile</label>
            </div>

            {/* Name Input */}
            <div>
              <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 px-1">Brand Name</label>
            ...
            <div className="flex items-center gap-3 pt-4">
              ...
              >
                ...
                {initialData ? 'Sync Changes' : 'Save Brand'}
              </button>
            </div>
          </form>
        </div>
