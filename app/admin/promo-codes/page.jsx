...
import { 
  ...
  RefreshCw, ChevronDown, Ticket, Tag, Clock,
  Loader2, Check, X
} from 'lucide-react';
...
export default function PromoCodesPage() {
  ...
  const handleSelectAll = () => {
    if (selectedIds.length === filteredPromoCodes.length) {
      setSelectedIds([]);
    } else {
      setSelectedIds(filteredPromoCodes.map(p => p.id));
    }
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="p-2 bg-white border border-slate-200 rounded-lg text-slate-500 hover:text-indigo-500 transition-all shadow-sm group"
          >
              ...
              <tr className="bg-slate-50/50">
                <th className="pl-6 w-10 py-3 text-left">
                  <div 
                    ...
                    selectedIds.length === filteredPromoCodes.length && filteredPromoCodes.length > 0
                ...
                >
                  ...
                  <td className="px-4 py-4 text-center">
                    <div className="flex flex-col items-center">
                       <span className="text-[13px] font-black text-slate-900 flex items-center gap-0.5">
