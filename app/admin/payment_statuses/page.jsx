      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Financial States</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight leading-none">Payment Statuses</h1>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-6 py-4 bg-rose-600 text-white rounded-2xl text-sm font-black shadow-xl shadow-rose-100 hover:bg-rose-700 transition-all active:scale-95 uppercase tracking-widest"
          >
            <Plus size={18} strokeWidth={2.5} /> New Status
          </button>
        </div>
      </div>
        ...
        <div className="p-6 border-b border-slate-50 bg-slate-50/20">
          <div className="relative w-full sm:w-96 group">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200 rounded-2xl text-sm font-medium focus:ring-4 focus:ring-rose-500/5 transition-all outline-none placeholder:text-slate-400"
              value={search}
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50">
                <th className="px-8 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Status Name</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Registry ID</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Date Created</th>
              ...
              {loading && paymentStatuses.length === 0 ? (
                ...
                >
                  ...
                  <td className="px-6 py-5">
                    <span className="text-xs font-medium text-rose-600/60 tracking-wider">ID:{item.id}</span>
                  </td>
                  <td className="px-6 py-5">
