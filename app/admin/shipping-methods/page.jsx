      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Shipping List</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight leading-none">Shipping Methods</h1>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Plus size={18} strokeWidth={2.5} /> New Shipping Method
          </button>
        </div>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50">
                <th className="px-8 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Shipping Name</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Price</th>
                <th className="px-6 py-5 text-xs font-bold text-slate-400 uppercase tracking-wider">Added On</th>
                  ...
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs font-medium text-slate-500 mt-0.5">ID:{method.id}</span>
                      </div>
                    </div>
                  </td>
